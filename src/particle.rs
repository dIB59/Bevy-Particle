use bevy::{prelude::*, window::{Monitor, PrimaryWindow}};
use rand::prelude::*;


pub type ParticleBundle = (Particle, Position, Mesh2d, MeshMaterial2d<ColorMaterial>, Transform);
...
pub fn create_particle(meshes: &mut ResMut<Assets<Mesh>>, materials: &mut ResMut<Assets<ColorMaterial>>, windows: Query<&Window>) -> ParticleBundle {
